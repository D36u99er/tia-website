        ...
        const translations = {
            de: {
                ...
                'team.member1.summary1': 'Geboren 1971 in Santa Rosa; Stanford-Doppelabschluss in Financial Engineering und Informatik.',
                'team.member1.summary2': 'Entwickelte KI-basierte Risiko-, Pricing- und Execution-Engines für die Deutsche Bank USA.',
                'team.member1.summary3': '2020 Mitgründer von TIA und Architekt des Genius Robot 5.0.',
                'team.member1.summary4': 'Leitet Robotik-F&amp;E, erklärbare KI und Incident-Readiness für alle Desks.',
                ...
                'team.member2.summary1': 'Geboren 1969 nahe München; promovierter Finanzingenieur der LMU.',
                'team.member2.summary2': 'Leitete Multi-Asset-Desks bei Deutsche Bank, Citi Europe und KfW.',
                'team.member2.summary3': 'Verknüpft KI-Trading, Governance-Rhythmen und Partnerkapital für skalierbares Wachstum.',
                'team.member2.summary4': 'Verantwortet Produkt-Roadmap, regulatorische Kooperationen und Key Accounts.',
            ...
            en: {
                ...
                'team.member1.summary1': 'Born in 1971 in Santa Rosa; holds dual Stanford degrees in financial engineering and computer science.',
                'team.member1.summary2': 'Built AI-driven risk, pricing, and execution engines for Deutsche Bank USA.',
                'team.member1.summary3': 'Co-founded TIA with Kurz in 2020 after the drawdown, architecting Genius Robot 5.0.',
                'team.member1.summary4': 'Leads robotics R&amp;D, explainable AI, and incident readiness across all desks.',
                ...
                'team.member2.summary1': 'Born near Munich in 1969; LMU Munich PhD with multi-asset trading leadership.',
                'team.member2.summary2': 'Led Deutsche Bank, Citi Europe, and KfW desks across global mandates.',
                'team.member2.summary3': 'Connects AI trading, governance cadences, and partner capital to scale the alliance.',
                'team.member2.summary4': 'Owns the product roadmap, regulatory conversations, and key client stewardship.',
            ...
            zh: {
                ...
                'team.member1.summary1': '1971 年出生于美国圣罗莎，斯坦福金融工程与计算机科学双学士。',
                'team.member1.summary2': '曾在德银美国打造 AI 风控与执行引擎。',
                'team.member1.summary3': '2020 年与 Thomas Kurz 共同创立 TIA，设计 Genius Robot 5.0。',
                'team.member1.summary4': '负责机器人研发、可解释 AI 与交易安全演练。',
                'team.member2.role': '同盟会创始人兼 CEO，统筹联盟生态的产品布局与监管合作。',
                'team.member2.quote': '“我们把机构团队与精选的 AI 技术栈和伙伴网络联结起来。”',
                'team.member2.summary1': '1969 年生于慕尼黑附近，慕尼黑大学金融工程博士。',
                'team.member2.summary2': '曾在德银、花旗欧洲与 KfW 主导多资产团队。',
                'team.member2.summary3': '统筹同盟会的 AI 交易、治理节奏与合作伙伴网络。',
                'team.member2.summary4': '专注产品路线、监管协同与核心客户关系。',
