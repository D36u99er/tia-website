        ...
        const translations = {
            de: {
                ...
                'elections.brief.eyebrow': 'Leadership-Auswahl 2025',
                'elections.brief.heading': 'Kerndaten zur TIA Wahl',
                'elections.brief.intro': 'Aus den vollständigen Wahlunterlagen destilliert: die wichtigsten Fakten, damit Sie schnell entscheiden können, wem Ihre Stimme gehört.',
                'elections.brief.evaluation.title': 'Bewertung & Jury',
                'elections.brief.evaluation.item1': 'Der TIA-Vorstand bewertet nach einem 100-Punkte-Raster.',
                'elections.brief.evaluation.item2': 'Community-Stimmen können bis zu 50 Zusatzpunkte bringen.',
                'elections.brief.reward.title': 'Belohnung für die Führung',
                'elections.brief.reward.item1': 'Fünfjährige Leitung und Freedom-Award-Nominierung.',
                'elections.brief.reward.item2': '500 Mio. € Projektbudget plus 5 Mio. € Prämie.',
                'elections.brief.reward.item3': '20 % Equity und ein Maybach S680 für fünf Jahre.',
                'elections.brief.support.title': 'Vorteile für Unterstützer:innen',
                'elections.brief.support.item1': 'Drei Jahre Zugriff auf das Siegermodell (>380 % erwartet).',
                'elections.brief.support.item2': '20 % Anteil am Preisgeld und an den Dividenden.',
                'elections.brief.support.item3': 'Lebenslange Ehrenmitgliedschaft und Rendite-Boost-Programm.',
                'elections.brief.phase1.title': 'Vorrunde · 01.04 – 30.06.2025',
                'elections.brief.phase1.desc': '195 Trading-Desks werden nach Performance, Strategie-Essay und Systemanteil bewertet.',
                'elections.brief.phase2.title': 'Zwischenrunde · 01.07 – 31.10.2025',
                'elections.brief.phase2.desc': 'Top 20 % entwickeln einen Fünfjahresplan und legen teilbare IP sowie Risikoergebnisse offen.',
                'elections.brief.phase3.title': 'Finale · 01.11.2025 – 30.04.2026',
                'elections.brief.phase3.desc': 'Zwei Finalist:innen liefern sechs Monate Live-Trading und globale Skalierungspläne.',
                ...
                'elections.details.eyebrow': 'Leadership-Auswahl 2025',
                'elections.details.heading': 'So läuft die TIA Leadership-Wahl',
                'elections.details.description': 'Der Auswahlprozess kombiniert harte Trading-Metriken, strategische Konzepte und Community-Votes. Die wichtigsten Eckpunkte auf einen Blick.',
                'elections.details.jury': '<h3>Jury &amp; Bewertung</h3><p>Jury: Mitglieder des Vorstands der Tethys Investment Alliance.</p><ul><li>Bewertung anhand klarer Kriterien mit maximal 100 Punkten.</li><li>Unterstützerstimmen fließen mit bis zu 50 Zusatzpunkten in die Schlussabstimmung ein.</li></ul>',
                'elections.details.scoring': '<h3>Ablauf &amp; Teilnehmer</h3><p>Das Programm umfasst drei Phasen vom offenen Qualifying bis zur finalen Leadership-Entscheidung.</p><p>195 Trader:innen erreichten die Zwischenrunde; die Top-20&nbsp;% (39 Personen) kämpfen um den Finaleinzug.</p>',
            ...
            en: {
                ...
                'elections.brief.eyebrow': 'Leadership Selection 2025',
                'elections.brief.heading': 'Key Facts for the TIA Vote',
                'elections.brief.intro': 'Distilled from the full election dossier: the essentials you need to decide whose vision earns your vote.',
                'elections.brief.evaluation.title': 'Scoring & Jury',
                'elections.brief.evaluation.item1': 'The TIA board evaluates every candidate on a 100-point rubric.',
                'elections.brief.evaluation.item2': 'Community ballots can contribute up to 50 additional points.',
                'elections.brief.reward.title': 'Reward for the Leader',
                'elections.brief.reward.item1': 'Five-year stewardship plus a Freedom Award nomination.',
                'elections.brief.reward.item2': '€500M program budget and a €5M cash award.',
                'elections.brief.reward.item3': '20% equity and a Maybach S680 for five years.',
                'elections.brief.support.title': 'Benefits for Supporters',
                'elections.brief.support.item1': 'Three-year access to the winning model (projected >380% return).',
                'elections.brief.support.item2': '20% share of prize cash and annual dividends.',
                'elections.brief.support.item3': 'Lifetime honorary membership and the TIA return-boost program.',
                'elections.brief.phase1.title': 'Preliminary · 01 Apr – 30 Jun 2025',
                'elections.brief.phase1.desc': '195 trading desks evaluated on performance, strategy essays, and system weighting.',
                'elections.brief.phase2.title': 'Intermediate · 01 Jul – 31 Oct 2025',
                'elections.brief.phase2.desc': 'Top 20% craft five-year plans and disclose shareable IP and risk metrics.',
                'elections.brief.phase3.title': 'Final · 01 Nov 2025 – 30 Apr 2026',
                'elections.brief.phase3.desc': 'Two finalists deliver six months of live trading with global scaling roadmaps.',
                ...
                'elections.details.phase2': '<h3>Mid-Round · Jul 1 – Oct 31, 2025</h3><p>Participants: Top 20% from qualifying (39 traders).</p><ul><li>Trading returns and risk profile during the period (50 pts)</li><li>Five-year transformation plan for the alliance (30 pts)</li><li>Sharable portion of proprietary IP (20 pts)</li></ul><p class=\"phase-result\">Outcome: Two finalists reach the leadership showdown.</p>',
                'elections.details.phase3': '<h3>Final Round · Nov 1, 2025 – Apr 30, 2026</h3><p>Participants: The two highest-ranked mid-round finalists.</p><ul><li>Six months of live trading performance (50 pts)</li><li>Blueprint for scaling professional strategies worldwide (30 pts)</li><li>Global sharing ratio of proprietary systems (20 pts)</li></ul><p class=\"phase-result\">Outcome: One leader is appointed to steer the alliance.</p>',
                'elections.details.rewards': '<h3>Honors for the new leader</h3><ul><li>Five-year mandate to lead the Tethys Investment Alliance.</li><li>Nomination for the Freedom Medal.</li><li>€1&nbsp;billion launch capital for the “Next Five-Year Dream Program”.</li><li>€5&nbsp;million cash award plus 20% equity.</li><li>Fully equipped Maybach S680 4MATIC for five years.</li></ul>',
            ...
            zh: {
                ...
                'elections.brief.eyebrow': '2025 领导力甄选',
                'elections.brief.heading': 'TIA 选举核心要点',
                'elections.brief.intro': '从完整选举资料提炼出的关键信息，帮助你快速判断把票投给谁。',
                'elections.brief.evaluation.title': '评分与评审团',
                'elections.brief.evaluation.item1': 'TIA 董事会按照 100 分量表逐项评分。',
                'elections.brief.evaluation.item2': '社区支持者投票可再贡献最高 50 分。',
                'elections.brief.reward.title': '当选领导人奖励',
                'elections.brief.reward.item1': '五年领导任期并提名 Freedom Award。',
                'elections.brief.reward.item2': '5 亿欧元项目预算与 500 万欧元现金奖励。',
                'elections.brief.reward.item3': '20% 股权以及迈巴赫 S680 五年使用权。',
                'elections.brief.support.title': '支持者权益',
                'elections.brief.support.item1': '三年免费接入冠军模型（预期收益 >380%）。',
                'elections.brief.support.item2': '共享 20% 现金奖与年度分红。',
                'elections.brief.support.item3': '终身荣誉会员资格与收益倍增计划席位。',
                'elections.brief.phase1.title': '初选 · 2025/04/01–2025/06/30',
                'elections.brief.phase1.desc': '195 个交易团队按收益、策略短文与体系占比打分。',
                'elections.brief.phase2.title': '中选 · 2025/07/01–2025/10/31',
                'elections.brief.phase2.desc': '前 20% 团队提交五年规划并披露可分享 IP 与风险成果。',
                'elections.brief.phase3.title': '决选 · 2025/11/01–2026/04/30',
                'elections.brief.phase3.desc': '两位决赛者进行六个月实盘交易并交付全球扩张方案。',
