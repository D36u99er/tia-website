        ...
        const translations = {
            de: {
                ...
                'footer.contact.email': 'hello@tethys-invest.com',
                'footer.contact.phoneLabel': 'Telefon',
                'footer.contact.phone': '+49 69 2474 8800',
                'footer.contact.siteLabel': 'Web',
                'footer.contact.site': 'https://tia.fund',
                ...
                'footer.summary.taxLabel': 'Steuernummer',
                ...
                'footer.legal.einDetail': 'Employer Identification Number (EIN): 39-4174820 (ausgestellt vom Internal Revenue Service, USA).',
                'footer.legal.labels.note': 'Hinweis gemäß § 27a UStG',
                'footer.legal.ustgNote': 'Als US-amerikanische Gesellschaft liegt keine deutsche USt-IdNr. vor.',
            ...
            en: {
                ...
                'footer.summary.address': '222 Sansome St, San Francisco, CA 94104, United States',
                ...
                'footer.legal.usAddress': '222 Sansome St, San Francisco, CA 94104, United States',
                'footer.legal.labels.represented': 'Vertreten durch',
                'footer.legal.representedValue': 'die Geschäftsführung',
                'footer.legal.labels.deAddress': 'German Contact Address (§ 5 Abs. 1 Nr. 1 TMG)',
                'footer.legal.deAddress': 'Mainzer Landstraße 16, 60325 Frankfurt am Main, Germany',
                'footer.legal.labels.taxInfo': 'Tax Information',
                'footer.legal.einDetail': 'Employer Identification Number (EIN): 39-4174820 (issued by the U.S. Internal Revenue Service).',
                'footer.legal.labels.note': 'Notice per § 27a UStG',
                'footer.legal.ustgNote': 'As a U.S. company, no German VAT ID is available.',
            ...
            zh: {
                ...
                'footer.legal.labels.represented': 'Vertreten durch',
                'footer.legal.representedValue': 'die Geschäftsführung',
                'footer.legal.labels.deAddress': '德国联系地址（nach § 5 Abs. 1 Nr. 1 TMG）',
                'footer.legal.deAddress': 'Mainzer Landstraße 16, 60325 Frankfurt am Main, Germany',
                'footer.legal.labels.taxInfo': '税务信息',
                'footer.legal.einDetail': 'Employer Identification Number (EIN): 39-4174820（由美国国税局签发）。',
                'footer.legal.labels.note': 'Hinweis gemäß § 27a UStG',
                'footer.legal.ustgNote': '由于属于美国公司，暂不具备德国增值税税号。',
